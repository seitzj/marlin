...
#define STRING_CONFIG_H_AUTHOR "(seitz, Ender-5-SKR-mini-E3-V3.0)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "BL-Touched Me"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-5
    ...
    #define DEFAULT_Kp_LIST {  20.49,  20.49 }
    #define DEFAULT_Ki_LIST {   1.38,   1.38 }
    #define DEFAULT_Kd_LIST {  76.01,  76.01 }
  #else
    #define DEFAULT_Kp  20.49
    #define DEFAULT_Ki   1.38
    #define DEFAULT_Kd  76.01
  #endif
#endif
